...
fn load_persist(app: &silvermoon_ipc::Host) -> NeteasePersist {
...
fn save_persist(app: &silvermoon_ipc::Host, p: &NeteasePersist) -> Result<(), String> {
    let path = persist_path(app)?;
    let json = serde_json::to_string_pretty(p).map_err(|e| e.to_string())?;
    std::fs::write(path, json).map_err(|e| format!("保存网易云登录态失败：{e}"))
}

fn clear_persist(app: &silvermoon_ipc::Host) {
...
fn get_xeapi_key(_app: &silvermoon_ipc::Host) -> Result<XeapiKey, String> {
    let device_id = {
...
fn fetch_account(_app: &silvermoon_ipc::Host) -> Result<NeteaseAccount, String> {
...
fn current_uid(app: &silvermoon_ipc::Host) -> Result<i64, String> {
...
pub async fn netease_login_qr_key(app: silvermoon_ipc::Host) -> Result<String, String> {
    // spawn_blocking：网络请求不占主线程，避免冻结 UI
    silvermoon_ipc::rt::spawn_blocking(move || netease_login_qr_key_sync(app))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}

fn netease_login_qr_key_sync(app: silvermoon_ipc::Host) -> Result<String, String> {
    // 启动时恢复持久化状态（仅首次）
    ensure_loaded(&app);
...
pub async fn netease_login_qr_check(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_login_qr_check_sync(app, key))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
#[silvermoon_ipc::command]
pub async fn netease_account(app: silvermoon_ipc::Host) -> Result<NeteaseAccount, String> {
    silvermoon_ipc::rt::spawn_blocking(move || netease_account_sync(app))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}

fn netease_account_sync(app: silvermoon_ipc::Host) -> Result<NeteaseAccount, String> {
    ensure_loaded(&app);
...
pub async fn netease_user_playlists(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_user_playlists_sync(app, offset, limit))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
pub async fn netease_playlist_detail(
    _app: silvermoon_ipc::Host,
    id: i64,
) -> Result<Vec<NeteaseSong>, String> {
    silvermoon_ipc::rt::spawn_blocking(move || netease_playlist_detail_sync(id))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
pub async fn netease_cloud(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_cloud_sync(offset, limit))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
pub async fn netease_song_url(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_song_url_sync(ids))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
pub async fn netease_sms_captcha_sent(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_sms_captcha_sent_sync(app, phone, ctcode))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
pub async fn netease_song_comments(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_song_comments_sync(app, id, offset, limit))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
pub async fn netease_set_song_liked(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_set_song_liked_sync(app, id, like))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
/// 我喜欢的音乐 ID 列表
#[silvermoon_ipc::command]
pub async fn netease_likelist(app: silvermoon_ipc::Host, uid: i64) -> Result<Vec<i64>, String> {
    silvermoon_ipc::rt::spawn_blocking(move || netease_likelist_sync(app, uid))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}

fn netease_likelist_sync(app: silvermoon_ipc::Host, uid: i64) -> Result<Vec<i64>, String> {
    ensure_loaded(&app);
    let (code, body) = api_call(
        "eapi",
        "/api/song/like/get",
...
pub async fn netease_recommend_playlists(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_recommend_playlists_sync(app, limit))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}
...
pub async fn netease_daily_recommend_songs(
    ...
    silvermoon_ipc::rt::spawn_blocking(move || netease_daily_recommend_songs_sync(app))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}

fn netease_daily_recommend_songs_sync(
    app: silvermoon_ipc::Host,
) -> Result<Vec<NeteaseSong>, String> {
    ensure_loaded(&app);
    let (code, body) = api_call(
...
/// 私人 FM
#[silvermoon_ipc::command]
pub async fn netease_personal_fm(app: silvermoon_ipc::Host) -> Result<Vec<NeteaseSong>, String> {
    silvermoon_ipc::rt::spawn_blocking(move || netease_personal_fm_sync(app))
        .await
        .map_err(|e| format!("网易云请求异常：{e}"))?
}

fn netease_personal_fm_sync(app: silvermoon_ipc::Host) -> Result<Vec<NeteaseSong>, String> {
    ensure_loaded(&app);
...
/// 退出登录：清内存 + 删持久化文件
#[silvermoon_ipc::command]
pub async fn netease_logout(app: silvermoon_ipc::Host) -> Result<(), String> {
    silvermoon_ipc::rt::spawn_blocking(move || {
        clear_persist(&app);
        Ok(())
    })
