...
# 扩展包模式下，主机通过 MIAOHUI_SUPPORT_DIR 把数据目录重定向到
# extensions/miaohui/data，避免污染用户主目录、也便于随扩展卸载清理。
_override = os.environ.get("MIAOHUI_SUPPORT_DIR")
if _override:
    SUPPORT_DIR = Path(_override)
